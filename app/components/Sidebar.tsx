					...
					<nav className="flex flex-1 flex-col">
						<ul className="flex flex-1 flex-col gap-y-7">
										...
										<li key={item.name}>
											<a
												...
												className={classNames(
													...
													'group flex gap-x-3 rounded-md p-2 text-sm font-normal leading-6 transition-colors'
												)}
											>
												<item.icon
													aria-hidden="true"
							...
							<li className="mt-auto">
								<a
									href="/settings"
									className="group -mx-2 flex gap-x-3 rounded-md p-2 text-sm font-normal leading-6 text-zinc-400 hover:bg-zinc-950 hover:text-white"
								>
									<Cog6ToothIcon
										aria-hidden="true"
										className="h-6 w-6 shrink-0"
				...
				<div className="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-4 border-b border-gray-200 bg-white px-4 shadow-sm dark:border-zinc-800 dark:bg-zinc-900 sm:gap-x-6 sm:px-6 lg:px-8">
					...
					<div className="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
						<div className="ml-auto flex items-center gap-x-4 lg:gap-x-6">
							<button
								type="button"
								className="-m-2.5 p-2.5 text-gray-400 transition-colors hover:text-gray-500 dark:text-zinc-600 dark:hover:text-white"
								onClick={toggleTheme}
							>
							...
							<Menu as="div" className="relative">
								<MenuButton className="-m-1.5 flex items-center p-1.5">
									...
									<span className="inline-block h-8 w-8 overflow-hidden rounded-full bg-gray-100 dark:bg-zinc-800">
										<svg
											fill="currentColor"
											viewBox="0 0 24 24"
									...
									<span className="hidden lg:flex lg:items-center">
										...
										<ChevronDownIcon
											aria-hidden="true"
											className="ml-2 h-5 w-5 text-gray-400 dark:text-zinc-600"
										/>
									</span>
								</MenuButton>
								<MenuItems
								...
								>
									<MenuItem>
										<a
											href={`/settings`}
											className="block px-3 py-1 text-sm leading-6 text-gray-900 data-[focus]:bg-gray-100 dark:text-white dark:data-[focus]:bg-sky-600"
										>
											Your profile
										</a>
									</MenuItem>
									...
									<MenuItem>
										<button
											className="block w-full px-3 py-1 text-left text-sm leading-6 text-gray-900 data-[focus]:bg-gray-100 dark:text-white dark:data-[focus]:bg-sky-600"
											type="submit"
											form="logoutForm"
										>
											Sign out
